...
**963 organizations. 695 people. Every one verified.**
...
| `data/people.csv` | Flat table — 695 public people profiles |
...
## Quick stats (v1.2.0, May 2026)

- **963 organizations** across BC — Vancouver, Victoria, Kelowna, Prince George, and beyond
- **695 people** — founders, researchers, operators, policymakers
