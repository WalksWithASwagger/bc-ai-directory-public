...
**963 organizations. 1,062 people. Every one verified.**
...
| `data/people.csv` | Flat table — 1,062 public people profiles |
...
## Quick stats (v1.6.0, May 2026)

- **963 organizations** across BC — Vancouver, Victoria, Kelowna, Prince George, and beyond
- **1,062 people** — founders, researchers, operators, policymakers
